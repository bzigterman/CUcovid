...
ggsave("UI/2UICases.png", width = 8, height = 4.5, dpi = 320)
ggsave("UICasesWeb.png", 
       path = "../bzigterman.github.io/images/",
       width = 8, height = 4.5, dpi = 320)
# ggsave("1TweetUICases.png", width = 8, height = 4, dpi = 150)
...
ggplot(uicovid, aes(x = as.Date(Date), y = New_Tests)) +
  ...
  theme(text = element_text(family = "Barlow"),
        ...
        axis.text.x = element_text(size = 12),
        plot.title = element_text(size = 22, family = "Oswald")) 
ggsave("UI/3UITests.png", width = 8, height = 4.5, dpi = 320)
ggsave("UITestsWeb.png", 
       path = "../bzigterman.github.io/images/",
       width = 8, height = 4.5, dpi = 320)
# ggsave("2TweetUITests.png", width = 8, height = 4, dpi = 150)
...
ggplot(uicovid, aes(x = as.Date(Date), y = positivity)) +
  ...
  theme(text = element_text(family = "Barlow"),
        ...
        axis.text.x = element_text(size = 12),
        plot.title = element_text(size = 22, family = "Oswald")) 
ggsave("UI/4UIPositivity.png", width = 8, height = 4.5, dpi = 320)
ggsave("UIPositivityWeb.png", 
       path = "../bzigterman.github.io/images/",
       width = 8, height = 4.5, dpi = 320)
# ggsave("3TweetUIPositivity.png", width = 8, height = 4, dpi = 150)
...
# ggsave("UITotals.png", width = 8, height = 4.5, dpi = 320)
# ggsave("4TweetUITotals.png", width = 8, height = 4, dpi = 150)
...
ggsave("UI/1UISemCompare.png", width = 8, height = 4.5, dpi = 320)
